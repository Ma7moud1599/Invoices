...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="left-content">
            <div>
                <h2 class="main-content-title tx-24 mg-b-1 mg-b-lg-1">مرحبًا بكم مرة أخرى {{ Auth::user()->name }}</h2>
            </div>
        </div>
    </div>
    <!-- /breadcrumb -->
                        ...
                        <div class="d-flex">
                            ...
                            <span class="float-right my-auto mr-auto">
                                <span class="text-white op-7">
                                    ...
                                    @php
                                    $count_all= \App\Models\invoices::sum('Total');
                                    $count_invoices2 = \App\Models\invoices::where('Value_Status', 2)->sum('Total');
                                    if($count_invoices2 == 0){
                                       echo $count_invoices2 = 0;
                                    }
                                    else{
                                        $count_invoices2 = $count_invoices2 / $count_all *100;
                                        echo  number_format($count_invoices2, 2). '%';
                        ...
                        <div class="d-flex">
                            ...
                            <span class="float-right my-auto mr-auto">
                                <span class="text-white op-7">
                                    @php
                                        $count_all= \App\Models\invoices::sum('Total');
                                        $count_invoices1 = \App\Models\invoices::where('Value_Status', 1)->sum('Total');
                                        if($count_invoices1 == 0){
                                           echo $count_invoices1 = 0;
                                        }
                                        else{
                                           $count_invoices1 = $count_invoices1 / $count_all *100;
                                            echo  number_format($count_invoices1, 2). '%';
                                        }
                                    @endphp
                                </span>
                            </span>
                        ...
                        <div class="d-flex">
                            ...
                            <span class="float-right my-auto mr-auto">
                                <span class="text-white op-7">
                                    @php
                                        $count_all= \App\Models\invoices::sum('Total');
                                        $count_invoices1 = \App\Models\invoices::where('Value_Status', 3)->sum('Total');
                                        if($count_invoices1 == 0){
                                           echo $count_invoices1 = 0;
                                        }
                                        else{
